...
import com.adilson.escola.cursos.gradecurricular.constants.ErrorMessagesConstants;
...
import com.adilson.escola.cursos.gradecurricular.repository.ICursoRepository;
...
public class CursoService implements ICursoService {
	...
	public Boolean cadastrar(CursoModel cursoModel) {
		try {
			...
			throw new CursoException(ErrorMessagesConstants.ERRO_GENERICO.getValor(), HttpStatus.INTERNAL_SERVER_ERROR);
		}
	}
